...
Again, from the plot above, Tte prevalence for cancer in the majority of Pennsylvania counties are above the calculated national average (5.6%). The county with the highest prevalence of cancer is Cameron County, while the county with the lowest is Philadelphia County. 
